...
class _NewAppointmentScreenState extends State<NewAppointmentScreen> {
  ...
  void salvar() async {
    ...
    final novo = Appointment(
      ...
      inicio: dataHora!,
      duracao: duracaoCtrl.text.isNotEmpty ? int.parse(duracaoCtrl.text) : duracao,
    );
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<int>(
                  initialValue: duracaoCtrl.text.isNotEmpty ? int.parse(duracaoCtrl.text) : duracao,
                  decoration: const InputDecoration(
                  ...
                  items: duracoes.map((d) {
                    return DropdownMenuItem(
                      value: d,
                      child: Text(duracoesDescription.elementAt(duracoes.indexOf(d))),
                    );
                  }).toList(),
                  onChanged: (value) {
                    setState(() {
                      duracao = value!;
                      duracaoCtrl.text = value.toString(); // 🔥 SINCRONIZA COM O CONTROLLER
                    });
                  },
